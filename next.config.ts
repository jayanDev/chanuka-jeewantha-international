		...
		const securityHeaders = [
			...
			},
			{
				...
				value: [
					...
					"connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://firestore.googleapis.com https://storage.googleapis.com https://calendly.com https://assets.calendly.com https://ipwho.is https://api.web3forms.com",
