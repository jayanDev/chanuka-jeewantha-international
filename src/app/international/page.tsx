...
export default function InternationalDirectory() {
  return <div className={styles.site}><section className={styles.titleBand}><div className={styles.container}><p className={styles.eyebrow}>Chanuka Jeewantha / Global career branding</p><h1>Career services for your next market.</h1><p>Premium CV, resume and LinkedIn services for {markets.length} markets. Founder-led, delivered remotely in English, with country-specific guidance and local-currency estimates.</p></div></section><section className={styles.band}><div className={styles.container}><CountryDirectory /></div></section></div>;
}
