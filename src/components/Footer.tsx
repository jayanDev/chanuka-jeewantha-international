      ...
      <div className="max-w-[1512px] mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6 lg:col-span-1">
            ...
            <p className="text-text-light/80 text-[16px] leading-relaxed max-w-sm">
              Premium international resume, CV, LinkedIn, cover letter, foreign job CV, and executive career branding services for global professionals.
            </p>
            <a href="https://chanukajeewantha.lk" className="text-sm font-semibold text-brand-main hover:text-white">
              For Sri Lankan clients, visit chanukajeewantha.lk
            </a>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li><Link href="/pricing" className="hover:text-brand-main transition-colors text-text-light/80">International Packages</Link></li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-4 text-text-light/80">
              <li className="flex items-start gap-3">
                ...
                <span>Remote international service for global professionals</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-brand-main mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                </span>
                <span>WhatsApp enquiries with country code accepted</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-brand-main mt-1">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-white text-sm">
            &copy; {currentYear} Chanuka Jeewantha. Global Career Branding Services.
          </p>
